...
# The embeddable distribution ships without pip or ensurepip. Unpack the bundled
# stdlib zip so `python -m ensurepip` works, then install the backend in-place.
...
if ($stdlibZip) {
    ...
    # Remove the marker file that tells Python to skip 'site' initialization.
